...
description: "CopilotSidebar 组件，提供与 copilot 交互的侧边栏界面。"
---
...
<Callout type="warning">
  `CopilotSidebar` 仍然受支持，但我们建议迁移到 v2 API 中的 [`CopilotSidebar`](/reference/v2/components/CopilotSidebar)。
</Callout>

<br/>
<img src="https://cdn.copilotkit.ai/docs/copilotkit/images/CopilotSidebar.gif" width="500" />

用于 CopilotKit 框架的聊天机器人侧边栏组件。可通过各种 props 和自定义 CSS 进行高度定制。

查看 [CopilotPopup](/reference/v1/components/chat/CopilotPopup) 获取此组件的弹出窗口版本。
