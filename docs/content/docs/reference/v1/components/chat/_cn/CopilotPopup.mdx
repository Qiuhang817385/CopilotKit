---
title: "CopilotPopup"
description: "CopilotPopup 组件，提供与 Copilot 交互的弹窗界面。"
---
...
<Callout type="warning">
  `CopilotPopup` 仍然受支持，但我们建议迁移到 v2 API 的 [`CopilotPopup`](/reference/v2/components/CopilotPopup)。
</Callout>

<br/>
<img src="https://cdn.copilotkit.ai/docs/copilotkit/images/CopilotPopup.gif" width="500" />

CopilotKit 框架的聊天机器人弹窗组件。该组件通过各种属性和自定义 CSS 实现高度可定制。

请参阅 [CopilotSidebar](/reference/v1/components/chat/CopilotSidebar) 获取该组件的侧边栏版本。
