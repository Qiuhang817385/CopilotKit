...
description: 通过 AG-UI 将您的 AWS Strands 智能体带给您的用户。
hideHeader: true
---
...
<FrameworkOverview
  ...
  header="将您的 AWS Strands 智能体带给用户"
  subheader="使用 CopilotKit 和 AG-UI 为您的 AWS Strands 智能体提供真正的用户交互性。构建丰富、交互式的智能体驱动应用程序。"
  ...
  supportedFeatures={[
    ...
    {
      title: "共享状态",
      description: "保持智能体和应用程序同步。您的智能体可以看到应用程序中的所有内容，您的应用程序可以实时响应智能体。",
  ...
  liveDemos={[
    {
      type: "saas",
      title: "SaaS Copilot",
      description: "由 AI 智能体增强的传统 SaaS 应用程序。这些 Copilot 无缝集成到现有工作流程中，为特定业务流程提供智能辅助。非常适合客户服务、销售自动化、项目管理以及用户需要引导式、分步 AI 辅助的特定领域任务。",
      iframeUrl: "https://examples-coagents-ai-travel-app.vercel.app?copilotOpen=true"
    },
    {
      type: "canvas",
      title: "画布 Copilot",
      description: "无限画布界面，用户在空间视觉环境中与 AI 智能体协作。这些 Copilot 在研究、头脑风暴、内容创作和复杂问题解决方面表现出色，在这些场景中信息需要以非线性、创造性的方式进行组织、连接和探索。",
